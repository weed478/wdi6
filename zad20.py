def zad18(tab, start=None, dest=None):
    ...
    def steps(pos):
        _steps = [(pos[0] - 1, pos[1] - 1, 7), (pos[0], pos[1] - 1, 0), (pos[0] + 1, pos[1] - 1, 1),
                  (pos[0] - 1, pos[1], 6), (pos[0] + 1, pos[1], 2),
                  (pos[0] - 1, pos[1] + 1, 5), (pos[0], pos[1] + 1, 4), (pos[0] + 1, pos[1] + 1, 3)]
        return _steps
    ...
    start = (start[0], start[1], -1)  # -1 stands for start
